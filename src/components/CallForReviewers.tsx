...
//         <title>Call for Reviewers | Scientific Committee ICHIS 2026</title>

//         {/* ✅ 2. DESCRIPTION: Targets "Peer Review" and "Committee" keywords */}
//         <meta 
//           name="description" 
//           content="Join the ICHIS 2026 Scientific Committee. We invite qualified academicians and researchers to serve as peer reviewers for the AI & Robotics conference in Rome." 
//         />

//         {/* ✅ 3. KEYWORDS: Specific to academic volunteering */}
//         <meta 
//           name="keywords" 
//           content="Call for Reviewers, Scientific Committee, Peer Review Service, Academic Volunteer, AI Research Evaluator, Technical Program Committee, ICHIS 2026" 
//         />
...
//         {/* 6. Open Graph */}
//         <meta property="og:title" content="Join the Scientific Committee - ICHIS 2026" />
...
//         <meta name="twitter:title" content="Call for Reviewers | ICHIS 2026" />
...
//           We invite qualified researchers and academicians to join the Review Committee of ICHIS 2026 and contribute to maintaining the academic quality of the conference.
//         </p>
//       </div>
...
//           title="Join as Reviewer for ICHIS 2026 Conference"
//           aria-label="Join as Reviewer for ICHIS 2026 Conference"
//         >
//           Join as Reviewer
//         </Link>
//       </div>
        ...
        <div className="bg-white px-6 pt-12 pb-8">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="mt-2 text-[17px] text-slate-600 max-w-3xl">
              Join the Scientific Committee and contribute to maintaining the academic quality of ICHIS 2026.
            </p>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="mb-12 border-l-2 border-[#0F766E]/40 pl-5">
            ...
            <p className="text-[16.5px] text-slate-600 leading-relaxed max-w-3xl">
              ...
              for ICHIS 2026 and help ensure the technical rigor, originality, and relevance
