...
// //           Join us in beautiful Rome for ICHIS 2026 — explore venue details, hotel options,
...
//           Experience Rome while attending ICHIS 2026 — discover venue location,
    ...
    <section className="py-20 px-6 lg:px-28 bg-white">
      <div className="container mx-auto text-center max-w-6xl">
        ...
        <p className="text-gray-600 text-base md:text-lg max-w-3xl mx-auto mb-10 leading-relaxed">
          Immerse yourself in the timeless beauty of Rome during ICHIS 2026. Explore comprehensive venue details, seamless travel arrangements, luxurious accommodation options, and discover the rich cultural attractions that surround our conference location.
        </p>
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 border border-indigo-200 p-10 shadow-xl flex flex-col lg:flex-row items-center justify-between gap-10 transition hover:shadow-2xl rounded-2xl">
          ...
          <Link
            ...
            title="View detailed venue and travel information for ICHIS 2026 Conference in Rome"
            aria-label="View detailed venue and travel information for ICHIS 2026 Conference in Rome"
          >
            View Venue Details
