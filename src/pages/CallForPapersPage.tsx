...
const CallForPapersPage: React.FC = () => {
  return (
    ...
    <Helmet>
      ...
      <title>Call for Abstracts | Health Innovation Summit Conference 2026 Rome</title>
      <meta 
        name="description" 
        content="Submit your abstract for ICHIS 2026. Join global researchers in AI, Machine Learning & Robotics in Rome, July 28-30. Deadline: Jan 30, 2026." 
      />

      {/* 2. Targeted Keywords for Research Submission */}
      <meta 
        name="keywords" 
        content="Call for Abstracts AI, Submit Paper Robotics Conference, ICHIS Abstract Submission, AI Research Call for Papers, Rome Conference Submission, Machine Learning Abstract" 
      />
      ...
      <meta property="og:title" content="Call for Abstracts - ICHIS 2026 Rome" />
      <meta property="og:description" content="We invite researchers to submit abstracts for the 3rd Global Conference on Health Innovation Summit. Share your work with international experts." />
      ...
      <meta name="twitter:description" content="Submit your research for the premier Health Innovation Summit conference in Rome." />
