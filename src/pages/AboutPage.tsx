...
//           <p className="text-xl">Discover the future of Health Innovation Summit</p>
//         </div>
//       </div>
...
function AboutPage() {
  return (
    <>
    <Helmet>
        <title>About ICHIS 2026 | Health Innovation Summit Conference Rome</title>
        
        <meta 
          name="description" 
          content="Learn about ICHIS 2026, the premier International Conference on Health Innovation Summit in Rome. Discover our mission, vision, and global impact." 
        />
        
        <meta 
          name="keywords" 
          content="About ICHIS, AI Conference Mission, Robotics Conference Vision, AI Summit Rome, Machine Learning Event Goals, Future of AI" 
        />
        ...
        {/* Open Graph / Facebook */}
        <meta property="og:title" content="About ICHIS 2026 - The Future of AI & Robotics" />
        ...
        <meta name="twitter:title" content="About ICHIS 2026 | Rome Conference" />
        <meta name="twitter:description" content="Discover the mission and vision of the 3rd Global Conference on Health Innovation Summit." />
          ...
          {`
            {
              ...
              "description": "The International Conference on Health Innovation Summit.",
              "location": {
                "@type": "Place",
      ...
      {/* <div className="relative bg-indigo-900 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-4 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-200 via-white to-indigo-200">
            The Future of Health Innovation Summit
          </h1>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 text-sm md:text-base">
            ...
            <div className="flex items-center gap-2 bg-white/10 px-6 py-3 backdrop-blur-md">
              ...
              <span>Crowne Plaza – St. Peter’s Seoul, South Korea</span>
            </div>
          </div>
  ...
  <video
    ...
    playsInline
    controls
    poster="/ICHIS-2026-video-poster.jpg"
  />
</div>
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
               The Health Innovation Summit 2026 brings together global healthcare leaders, medical researchers, clinicians, public health experts, biotechnology innovators, and digital health pioneers to explore the future of healthcare transformation.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                This international platform focuses on advancing healthcare systems, promoting translational research, and accelerating innovation in biomedical sciences, digital medicine, and patient-centered care.
              </p>
      ...
      {/* <div className="py-12 bg-gradient-to-r from-indigo-900 to-blue-900 text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-4">JOIN ICHIS 2026</h2>
          <p className="text-lg text-indigo-200 mb-8 max-w-2xl mx-auto">
            Participate in an international academic forum dedicated to Health Innovation Summit.
          </p>
          <Link to="/register">
